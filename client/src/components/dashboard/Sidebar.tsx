...
export function Sidebar() {
  return (
    <aside className="sticky top-[88px] flex h-[calc(100vh-104px)] w-[240px] shrink-0 flex-col gap-5 rounded-xl bg-cover bg-[position:75%_center] p-4" style={{ backgroundImage: "url(/images/Dashboard.png)" }}>
      <VerifiedSellerBadge />
